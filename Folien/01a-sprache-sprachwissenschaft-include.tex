...
\begin{itemize}
	\item Welches ist das \textbf{Untersuchungsgegenstand} der Linguistik?\\
...
\begin{itemize}
	...
	\item[]
	\item<2-> Sie ist \textbf{artspezifisch} ist, \dash dass nur Menschen eine Sprache (in dem oben genannten Sinne) haben\footnote{Vergleiche auch \citet{Bussmann83a}: \gqq{Sprache als eine {[}\ldots] nur dem Menschen eigene Ausdrucksform {[}\ldots]}.}.\\
