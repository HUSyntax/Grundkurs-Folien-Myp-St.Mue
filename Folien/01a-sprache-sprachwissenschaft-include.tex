...
\frametitle{Begleitlektüre}
	\begin{itemize}
	\item AM S.~2--6
	\item \citet{Luedeling2009}: Kapitel 1 (S.~8--17) \& 3 (S.~28--41)
	\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\footnote{Vergleiche auch \citet{Bussmann83a}: \gqq{Sprache als eine {[}\ldots] nur dem Menschen eigene Ausdrucksform {[}\ldots]}.}.\\
 ...
 (\zb Esperanto), formalen Sprachen (\zb C++), etc. (vgl. \citet{Thuemmel00a}).\
\end{itemize}		
...
\begin{frame}
	...
	\begin{block}{Natürliche Sprache}
			Insgesamt bildet die natürliche Sprache also ein \textbf{produktives}, \textbf{bidirektionales}, \textbf{arbiträres} und \textbf{diskretes} Symbolsystem (vgl. \citet{Luedeling2009}).
	\end{block}
