...
\pause
		 \ea Wieso spricht man \ab{Hund} mit \textipa{[t]} aber \ab{Hunde} mit \textipa{[d]} aus?
\pause
			\ex Kann ein Wort im Deutschen mit der Lautfolge \textipa{[Ng]} beginnen?
\pause
			\ex Was ist der Unterschied zwischen \abu{HAUStürgriff} und \abu{HausTÜRgriff}?
		\z	  
...
\begin{frame}{Abbildungen}
	\begin{itemize}
		\item ABBILDUNG -- Machichao y Priemer, Antonio: \gqq{Duden} (Privatfoto).
	\end{itemize}
\end{frame}
