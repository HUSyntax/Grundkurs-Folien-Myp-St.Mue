...
Mehrere Körperteile sind für Erzeugung von Schall nötig:
		...
		\begin{itemize}
			...
			\item[] Frequenz bestimmt die Tonhöhe:
...
<<<<<<< HEAD
1. Busch &{[\textipa{bUS}]} 								& \visible<2->{b: bilabialer, stimmhafter Plosiv \textipa{S}:~postalveolarer, stimmloser Frikativ}\\
\pause\pause
2. malen & {[\textipa{\textprimstress ma:l@n}]} 	& \visible<4->{m:~bilabialer, stimmhafter Nasal; n:~alveolarer, stimmhafter Nasal, l:~alveolaer, stimmhafter Lateral}\\
\pause\pause
3. Maus & {[\textipa{m\t{aU}s}]}							& \visible<6->{m:~s.o.; s:~stimmloser, alveolarer Frikativ} \\
\pause\pause
4. Achtung &{[\textipa{\textprimstress aXtU\ng}]} & \visible<8->{\textipa{X}:~velarer, stimmloser Frikativ; t:~alveolarer, stimmloser Plosiv \textipa{\ng}: velarer, stimmhafter Nasal}\\
\pause\pause
5. Genie	&{[\textipa{Ze:\textprimstress ni:}]}		& \visible<10->{\textipa{Z}: postalveolarer, stimmhafter Frikativ, n:~s.o.}\\
\pause\pause
6. zirpen & {[\textipa{\t{ts}IKp@n}]}						& \visible<12->{\textipa{\t{ts}}: alveolare, stimmlose Affrikate; \textipa{K}:~uvularer, stimmhafter Frikativ; p:~bilabialer, stimmloser Plosiv; n: s.o.}\\
\pause\pause
7. wichtig & {[\textipa{\textprimstress vI\c{c}tI\c{c}}]} & \visible<14->{\textipa{v}: labiodentaler, stimmhafter Frikativ; \textipa{\c{c}}: palataler, stimmloser Frikativ t: s.o.}\\
\pause
8. Wald 	&	{[\textipa{valt}]}									& \visible<16->{v, l, t: s.o.}\\
\pause
=======
...
\pause
4. Achtung &{[\textipa{\textprimstress PaXtU\ng}]} & \textipa{P}:~glottaler, stimmloser Plosiv; \textipa{X}:~velarer, stimmloser Frikativ; t:~alveolarer, stimmloser Plosiv; \textipa{\ng}: velarer, stimmhafter Nasal\\
\pause
...
\pause
8. Wald 	&	{[\textipa{valt}]}									& \textipa{v}; \textipa{l}; \textipa{t}: s.o.\\
>>>>>>> 6ce236ee68584f475e1a3ccef8bc9cb02e54c5f5
\end{tabular}}
\end{table}
