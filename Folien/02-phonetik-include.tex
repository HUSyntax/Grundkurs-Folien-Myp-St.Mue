...
\begin{itemize}
	...
	\item<2-> \textcolor{red}{Ja: \textipa{[ \texttoptiebar{ts} \texttoptiebar{aI} t ]} , \textipa{[h \texttoptiebar{aU} s ]}}
	\item<2-> \textcolor{red}{Nein: \textipa{[ n a . P i: f ]}}
\end{itemize}
...
\settowidth\jamwidth{XXXXXXXXXXXXXXXXXXXXXXXXXX} 
		\ea Bergsteiger
		\jambox{\alertred{%
						\only<2->{ \textipa{[bE͡5k.St\t{aI}.g5]}}	
}}
		\ex Quotennote
		\jambox{\alertred{%
		\only<3->{ \textipa{[kvo:.t@n.no:.t@]}}	
}}
		\ex vielfaches
		\jambox{\alertred{%
		\only<4->{ \textipa{[fi:l.fa\.x@s]}}	
}}
		\ex Päckchenannahme
		\jambox{\alertred{%
		\only<5->{ \textipa{[pEk.\c{c}@n.Pan.na:.m@]}}	
}}
		\ex beenden
		\jambox{\alertred{%
		\only<6->{ \textipa{[b@.PEn.d@n]}}	
}}
		\ex verreisen
		\jambox{\alertred{%
		\only<7->{ \textipa{[fE͡5.\textscr \t{aI}.z@n]}}	
}}
		\ex vereisen
		\jambox{\alertred{%
		\only<8->{ \textipa{[fE͡5.P\t{aI}.z@n]}}	
}}
		\ex Einzahlung
		\jambox{\alertred{%
		\only<9->{ \textipa{[P\t{aI}n.\t{ts}a:.lUN]}}	
}}
		\ex gehen
		\jambox{\alertred{%
		\only<10->{ \textipa{[ge:.@n]}}	
...
\begin{itemize}
	\item[2.] {Schreiben Sie für folgenden Lautbeschreibungen das passende IPA-Symbol auf:}
...
\begin{itemize}
	...
	\begin{exe}
		...
		\begin{xlist}
			...
			\ex halbtiefer zentraler ungerundeter \uwave{ungespannter} Vokal\jambox{\only<8->{\textcolor{red}{
						\textipa{[5]}
					}}}
