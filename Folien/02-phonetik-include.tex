...
%\frametitle{Probleme der Phonetik}
	...
	\caption{Spektrogramm \gqq{Pronouncing}}
...
\begin{itemize}
	...
	\ea 
	\begin{itemize}
		\item \t{\textipa{aɪ5}} \ras Eier
		\item \t{\textipa{ɔɪ5}} \ras Steuer
		\item \t{\textipa{aʊ5}} \ras Bauer
	\end{itemize}
	\z
...
\begin{frame}[allowframebreaks]{Abbildungen}
	\small
		...
		\begin{itemize}
			...
			\item ABBILDUNG -- \gqq{Sagitalschnitt} (CC BY-SA 3.0, Zugriff: 09.12.16) \url{https://commons.wikimedia.org/w/index.php?curid=2615572}
		\end{itemize}	
