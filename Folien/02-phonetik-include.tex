...
%\vspace{1em}
		...
		\begin{itemize}
			...
			\ex \textipa{[ \~o ]} in \ab{T\textbf{eint}}
			\ex \textipa{[ \~E ]} in \ab{Restaur\textbf{ant}}
...
\begin{frame}{Vokalviereck}
	...
	\begin{figure}[H]
		...
		\includegraphics[scale=0.37]{material/04ipatabellerepp11vokalviereck} %%kein gutes lizensfreies Bild gefunden%%
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ea \textipa{[ \t{i5} , \t{I5} , \t{e5} , \t{u5} , \t{y5} , \t{Y5} , \t{\o5} , \t{\textupsilon5} , \t{o5} ]} in \abu{hier, Birke, mehr, stur, für, mürrisch, stör, knurr, Ohr}
		\z
...
\begin{itemize}
	...
	\ea \textipa{[ \t{aI5} , \t{OI5}, \t{a\textupsilon5} ]} in \ab{Eier, Steuer, Bauer}
	\z
...
\begin{itemize}
	...
	\item[]
	\item<2-> Ja: \textipa{[ \t{ts} \t{aI} t ]} , \textipa{[h \t{a\textupsilon} s ]}
		...
		\item Transkribieren Sie die folgenden Wörter nach einer standarddeutschen Aussprache:
			...
			\column{.40\textwidth}
				\begin{enumerate}
					...
					\item<2> \textipa{[P\t{aI}n.\t{ts}a:.l\textupsilon N]}
					\item<2> \textipa{[ge:.@n]}
