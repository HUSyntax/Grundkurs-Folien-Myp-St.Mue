...
=======
       ...
       \end{itemize}         
>>>>>>> 43c0faa3f2513fe4c5261e67d5fa523f53bdfedd
...
\begin{description}
	\item[Definition 1] \textipa{[ i:, y:, u:, o: ]} mit mehr Muskelspannung als \textipa{[ i:, y:, u:, o: ]} 
	
	(von der experimentellen Phonetik weder bestätigt noch widerlegt)
	
	\item[Definition 2] \textipa{[ i:, y:, u:, o: ]}  mit vorverlagerter Zungenwurzel
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Unterklassen der Diphthonge: fallende Diphthonge}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Unterklassen der Diphthonge: steigende Diphthonge}		
...
<<<<<<< HEAD
	\ea {[}\textipa{\t{aI5}}]: \ab{Eier}
	\ex {[}\textipa{\t{OI5}}]: \ab{Steuer}
	\ex {[}\textipa{\t{aU5}}]: \ab{Bauer}
	\z
=======
	\eal
