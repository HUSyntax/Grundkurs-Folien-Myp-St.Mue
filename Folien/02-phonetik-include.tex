...
\begin{frame}{Methodik}
	...
	\begin{figure}[H]
		...
		\includegraphics[scale=0.07]{material/04Rousselots_Apparat_zur_Aufzeichnung_der_Sprache}
		\caption{Rousselots Apparat zur Aufzeichnung der Sprache (Holzstich, um 1900). https://de.wikipedia.org/wiki/Jean-Pierre_Rousselot#/media/File:Rousselots_Apparat_zur_Aufzeichnung_der_Sprache.jpg Stand: 09.12.16}
		%{material/04proband}
...
%\centering
%\tiny
%\begin{tabular}[c]{|p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.06\textwidth}|p{0.06\textwidth}|p{0.06\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.04\textwidth}|p{0.04\textwidth}|p{0.04\textwidth}|p{0.04\textwidth}|}
%\hline
%& Bilabial & Labiodental & Dental & Alveolar & Postalveolar & Retroflex & Palatal & Velar & Uvular & \multicolumn{2}{|c|}{Pharyngal} & \multicolumn{2}{|c|}{Glottal} \\
%\hline
%Plosive & \textipa{p b} & & \multicolumn{3}{|c|}{\textipa{t d}} & \textipa{\:d \:t} & \textipa{c \textbardotlessj} & \textipa{k g} & \textipa{q \textscg} &  &  & \textipa{P} & \\
%\hline
%Nasale & \textipa{m} & \textipa{\textltailm} & \multicolumn{3}{|c|}{\textipa{n}} & \textipa{\textrtailn} & \textipa{\textltailn} & \textipa{\ng} & \textipa{\textscn} & & & &\\
%\hline
%Vibranten & \textipa{\textscb} & & \multicolumn{3}{|c|}{\textipa{r}} & & & & \textipa{\textscr} & & &&\\
%\hline
%Taps/ Flaps & & &  \multicolumn{3}{|c|}{\textipa{\textfishhookr}} &  \textipa{\textrtailr} & & & & & &&\\
%\hline
%Frikative & \textipa{\textphi \textbeta} & \textipa{f v} & \textipa{\texttheta \dh} & \textipa{s z} & \textipa{S Z} & \textipa{\:s \:z} & \textipa{\c{c} J} & \textipa{x G} & \textipa{X \textinvscr} & \multicolumn{2}{|c|}{\textipa{\textcrh \textrevglotstop}} & \multicolumn{2}{|c|}{\textipa{h \texthth}} \\
%\hline
%Laterale Frikative & & & \multicolumn{3}{|c|}{\textipa{\textbeltl \textlyoghlig}} & & & & & & \\
%\hline
%Approximanten & & \textipa{\textscriptv} & \multicolumn{3}{|c|}{\textipa{\textturnr}} & \textipa{\:R} & \textipa{j} & \textipa{\textturnmrleg} & & &  &&\\
%\hline
%Laterale Approximanten & & & \multicolumn{3}{|c|}{\textipa{l}} & \textipa{\:l} & \textipa{\textturny} & \textipa{\textscl} & & & &&\\
%\end{tabular}
%\caption{Pulmonische Konsonanten, IPA (2005) https://www.internationalphoneticassociation.org/sites/default/files/pulmonic.gif Stand: 09.12.16} 
%\end{table}
%
%\end{frame}
...
\frametitle{Monophthong, Diphthong, Triphthong}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\ea Im Bayrischen: \textipa{[ \t{Ia} , \t{Ua} ]} oder \textipa{[ \textsubarch{I}a , \textsubarch{U}a ]} (in \ab{liap} und \ab{guat})
			\z
