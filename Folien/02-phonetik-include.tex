...
\begin{frame}
\frametitle{Vokale im IPA-Alphabet}
...
Vokalviereck: Vokale links des Punktes sind ungerundet, die rechts sind gerundet
...
\frametitle{Vokale im Deutschen}
	...
	\node at (-0.5,2.5){\rotul{\textipa{I}} \textipa{\underline{Y}}};
...
\textbf{UE:} Beschreiben Sie die Konsonanten in den folgenden Wörtern und geben Sie die entsprechenden phonetischen Symbole an:
...
\begin{enumerate}
	\item {[\textipa{bUS}]}
	\item {[\textipa{\textprimstress ma:l@n}]}
	\item {[\textipa{m\t{aU}s}]}
	\item {[\textipa{\textprimstress aXtU\ng}]}
	\item {[\textipa{Ze:\textprimstress i:}]}
	\item {[\textipa{\t{ts}IKp@n}]}
	\item {[\textipa{\textprimstress vI\c{c}tI\c{c}}]}
	\item {[valt]}
\end{enumerate}
\column{.70\textwidth}
\scriptsize
\begin{enumerate}
	\item[] b: bilabialer, stimmhafter Plosiv \textipa{S}:~postalveolarer, stimmloser Frikativ
	\item[]  m:~bilabialer, stimmhafter Nasal; n:~alveolarer, stimmhafter Nasal, l:~alveolaer, stimmhafter Lateral
	\item[]  m:~s.o.; s:~stimmloser, alveolarer Frikativ
	\item[]  \textipa{X}:~velarer, stimmloser Frikativ
	\item[]  \textipa{Z}: postalveolarer, stimmhafter Frikativ, n:~s.o.
	\item[] \textipa{\t{ts}}: alveolare, stimmlose Affrikate; \textipa{K}:~uvularer, stimmhafter Frikativ; p:~bilabialer, stimmloser Plosiv; n: s.o.
	\item[]  \textipa{v}: labiodentaler, stimmhafter Frikativ; \textipa{\c{c}}: palataler, stimmloser Frikativ; t: alveolarer, stimmloser Plosiv
	\item[]  v, l, t: s.o.
\end{enumerate}
\end{columns}
