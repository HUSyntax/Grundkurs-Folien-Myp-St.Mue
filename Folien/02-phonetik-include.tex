...
\centering
\small
\begin{tabular}[c]{|p{0.07\linewidth}|l|l|l|l|l|l|l|l|l|p{0.03\linewidth}|p{0.03\linewidth}|p{0.03\linewidth}|p{0.03\linewidth}|}
\hline
& Bilabial & Labiodental & Dental & Alveolar & Postalveolar & Retroflex & Palatal & Velar & Uvular & \multicolumn{2}{|l|}{Pharyngal} & \multicolumn{2}{|l|}{Glottal} \\
\hline
Plosive & {\Large \textipa{p b}} & & \multicolumn{3}{|c|}{\large \textipa{t d}} & {\Large \textipa{\:t \:d}} & {\Large \textipa{c \textbardotlessj}} & {\Large \textipa{k g}} & {\Large \textipa{q \textscg}} & & \cellcolor{gray} & {\Large \textipa{P}} & \cellcolor{gray} \\
\hline
Nasale & {\Large \textipa{m}} & {\Large \textipa{\textltailm}} & \multicolumn{3}{|c|}{\Large \textipa{n}} & {\Large \textipa{\textrtailn}} & {\Large \textipa{\textltailn}} & {\Large \textipa{\ng}} & {\Large \textipa{\textscn}} &\multicolumn{2}{|c|}{\cellcolor{gray}} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
Vibranten & {\Large \textipa{\textscb}} & & \multicolumn{3}{|c|}{\Large \textipa{r}} & & & \cellcolor{gray} & {\Large \textipa{\textscr}} & \multicolumn{2}{|c|}{} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
Taps/ Flaps & & & \multicolumn{3}{|c|}{\Large \textipa{\textfishhookr}} &  {\Large \textipa{\textrtailr}} & & \cellcolor{gray} & & \multicolumn{2}{|c|}{} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
Frikative & {\Large \textipa{\textphi \textbeta}} & {\Large \textipa{f v}} & {\Large \textipa{\texttheta \dh}} & {\Large \textipa{s z}} & {\Large \textipa{S Z}} & {\Large \textipa{\:s \:z}} & {\Large \textipa{\c{c} J}} & {\Large \textipa{x G}} & {\Large \textipa{X \textinvscr}} & \multicolumn{2}{|c|}{\Large \textipa{\textcrh \textrevglotstop}} & \multicolumn{2}{|c|}{\Large \textipa{h \texthth}} \\
\hline
Laterale Frikative & \cellcolor{gray} & \cellcolor{gray} & \multicolumn{3}{|c|}{\Large \textipa{\textbeltl \textlyoghlig}}& & & & & \multicolumn{2}{|c|}{\cellcolor{gray}} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
Approxi-manten & & {\Large \textipa{\textscriptv}} & \multicolumn{3}{|c|}{\Large \textipa{\textturnr}} & {\Large \textipa{\:R}} & {\Large \textipa{j}} & {\Large \textipa{\textturnmrleg}} & & \multicolumn{2}{|c|}{} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
Laterale Approximanten & \cellcolor{gray} & \cellcolor{gray} & \multicolumn{3}{|c|}{\Large \textipa{l}} & {\Large \textipa{\:l}} & {\Large \textipa{\textturny}} & {\Large \textipa{\textscl}} & & \multicolumn{2}{|c|}{\cellcolor{gray}} & \multicolumn{2}{|c|}{\cellcolor{gray}}\\
\hline
\end{tabular}
\caption{Pulmonische Konsonanten, IPA (2005). (Vgl.https://www.internationalphoneticassociation.org/sites/default/files/pulmonic.gif Stand: 09.12.16)} 
\end{table}
