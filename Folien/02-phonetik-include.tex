...
\frametitle{Vokale im Deutschen}
	...
	\node[left] at (2,3){\textipa{W}};
	\node[right] at (2,3){\rotul{\textipa{u}}};
	\node at (1.5,2.5){\rotul{\textipa{U}}};
	\node[left] at (2,2){\textipa{7}};
	\node[right] at (2,2){\rotul{\textipa{o}}};
	\node[left] at (2,1){\textipa{2}};
	\node[right] at (2,1){\rotul{\textipa{O}}};
	\node[right] at (2,0){\textipa{6}};
	\node[left] at (2,0){\textipa{A}};
	\draw[black] (2,0)--(2,3);
	\node[left] at (0.5,2){\textipa{9}};
	\node[right] at (0.5,2){\textipa{8}};
	\node at (0.625,1.5){\rotul{\textipa{@}}};
	\node[left] at (0.75,1){\textipa{3}};
	\node[right] at (0.75,1){\textipa{\textcloserevepsilon}};
	\node at (0.875,0.5){\rotul{\textipa{5}}};
	\node at (1,0){\rotul{\textipa{a}}};
	\node[right] at (-1.5,3){\rotul{\textipa{y}}};
	\node[left] at (-1.5,3){\rotul{\textipa{i}}};
	\node[left] at (-0.5,2.5){\rotul{\textipa{I}}};
	\node[right] at (-0.5,2.5){\rotul{\textipa{Y}}};
	\draw[fill] (-0.5,2.5) circle [radius=0.05];
	\node[right] at (-1,2){\rotul{\textipa{\o}}};
	\node[left] at (-1,2){\rotul{\textipa{e}}};
	\node[right] at (-0.5,1){\rotul{\textipa{\oe}}};
	\node[left] at (-0.5,1){\rotul{\textipa{E}}};
	\node[right] at (0,0){\textipa{\OE}};
	\draw[black] (0,0)--(-1.5,3);
	\draw[black] (-0.5,2)--(0.2,2);
	\draw[black] (0.85,2)--(1.6,2);
...
%	\centering
	...
	\node[right] at (2.5,0){\scriptsize tief};
	\node[left] at (2,3){\textipa{W}};
	\node[right] at (2,3){\color<6>{red}{\underline{\textipa{u}}}};
	\node at (1.5,2.5){\color<6>{red}{\underline{\textipa{U}}}};
	\node[left] at (2,2){\textipa{7}};
	\node[right] at (2,2){\color<7>{red}{\underline{\textipa{o}}}};
	\node[left] at (2,1){\textipa{2}};
	\node[right] at (2,1){\color<7>{red}{\underline{\textipa{O}}}};
	\node[right] at (2,0){\textipa{6}};
	\node[left] at (2,0){\textipa{A}};
	\draw[black] (2,0)--(2,3);
	\node[left] at (0.5,2){\textipa{9}};
	\node[right] at (0.5,2){\textipa{8}};
	\node at (0.625,1.5){\color<8>{red}{\underline{\textipa{@}}}};
	\node[left] at (0.75,1){\textipa{3}};
	\node[right] at (0.75,1){\textipa{\textcloserevepsilon}};
	\node at (0.875,0.5){\color<8>{red}{\underline{\textipa{5}}}};
	\node at (1,0){\color<9>{red}{\underline{\textipa{a}}}};
	\node[right] at (-1.5,3){\color<1>{red}{\underline{\textipa{y}}}};
	\node[left] at (-1.5,3){\color<1>{red}{\underline{\textipa{i}}}};
	\node[left] at (-0.5,2.5){\color<2>{red}{\underline{\textipa{I}}}};
	\node[right] at (-0.5,2.5){\color<2>{red}{\underline{\textipa{Y}}}};
	\draw[fill] (-0.5,2.5) circle [radius=0.05];
	\node[right] at (-1,2){\color<3,5>{red}{\underline{\textipa{\o}}}};
	\node[left] at (-1,2){\color<3>{red}{\underline{\textipa{e}}}};
	\node[right] at (-0.5,1){\color<4-5>{red}{\underline{\textipa{\oe}}}};
	\node[left] at (-0.5,1){\color<4>{red}{\underline{\textipa{E}}}};
	\node[right] at (0,0){\textipa{\OE}};
	\draw[black] (0,0)--(-1.5,3);
	\draw[black] (-0.5,2)--(0.2,2);
	\draw[black] (0.85,2)--(1.6,2);
...
\begin{minipage}{.25\textwidth}
	\begin{itemize}
	\only<1>{\item Liege [\textipa{li:g@}], Lüge [\textipa{ly:g@}]}
		\only<2>{\item Kiste [\textipa{kIst@}], Küste [\textipa{kyst@}]}
		\only<3>{\item Wege [\textipa{ve:g@}], wöge [\textipa{vø:g@}]}
		\only<4>{\item helle [\textipa{hEl@}], Hölle [\textipa{hœl@}]}
		\only<5>{\item Höhle [\textipa{hø:l@}], Hölle [\textipa{hœl@}]}
		\only<6>{\item Mus [\textipa{mu:s}], muss [\textipa{mUs}]}
		\only<7>{\item Ofen [\textipa{o:f@n}], offen [\textipa{Of@n}]}
		\only<8>{\item geben [\textipa{ge:b@n}], Lehrer [\textipa{Le:K5}]}
		\only<9>{\item Lab [\textipa{la:p}]}
	\end{itemize}
\end{minipage}

\end{frame}
%% \begin{frame}
%% \frametitle{Deutsche Vokale im IPA-Alphabet}
