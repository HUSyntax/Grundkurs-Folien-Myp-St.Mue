...
%\frametitle{Einführung}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[]
			\item Hawaianisch: 11--13 Laute (eher Phoneme)
			\item[]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsubsection{Vokalklassifikation}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsubsection{Monophthong, Diphthong, Triphthong}
%\frame{
%\begin{multicols}{2}
%	\tableofcontents[currentsection]
%\end{multicols}
...
\frametitle{Monophthong, Diphthong, Triphthong}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\ea \textipa{[ \t{aI} , \t{a\textupsilon} , \t{OI} ]} oder \textipa{[ a\textsubarch{I} , a{\textsubarch{\textupsilon}} , O\textsubarch{I} ]}
			\z

			\item[]
			\item \textbf{steigende} (oder öffnende) Diphthonge\\

			\ea Im Bayrischen: \textipa{[ \t{Ia} , \t{\textupsilon a} ]} oder \textipa{[ \textsubarch{I}a , {\textsubarch{\textupsilon}}a ]} (in \ab{liap} und \ab{guat})
			\z
...
\begin{frame}{\textipa{[ S l \textupsilon\ s ]}}
...
%		
%		\begin{itemize}
%			\item Abbildung: Rousselots Apparat zur Aufzeichnung der Sprache \url{https://de.wikipedia.org/wiki/Jean-Pierre_Rousselot#/media/File:Rousselots_Apparat_zur_Aufzeichnung_der_Sprache.jpg} \\
%			{[}Zugriff: 09.12.16] 
%			\item Abbildung: Spektrogramm \gqq{Pronouncing} \url{https://upload.wikimedia.org/wikipedia/commons/3/30/Pronouncing.PNG?uselang=de} \\ {[}Autor: Rjanag; Zugriff: 20.12.16]
%			\item Abbildung Vokale CC BY-SA 3.0 \url{https://en.wikipedia.org/w/index.php?curid=3368128} \\ {[}Zugriff: 09.12.16]
%		\end{itemize}
%			\item Abbildung: Sagitalschnitt, By 아흔 - Own work, CC BY-SA 3.0, \url{https://commons.wikimedia.org/w/index.php?curid=2615572} \\ {[}Zugriff: 09.12.16]
%	}
%	
%\end{frame}
