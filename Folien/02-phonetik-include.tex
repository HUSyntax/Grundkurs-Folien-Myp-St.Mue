...
\begin{frame}
	...
	\begin{itemize}
		\item Phonetik I: AM S.~2--6; \citet{Luedeling09a}: Kapitel 1 (S.~8--17) \& 3 (S.~28--41)
		\item Phonteik II: AM S.~7--12; \citet{Hall00a}: Kapitel 1 (S.~3--16; 19--31) 
	\end{itemize}
\end{frame}
...
\begin{figure}
	...
	\node[right] at (2.5,0){\scriptsize tief (open)};
	\node[left] at (2,3){\textipa{W}};
	\node[right] at (2,3){\textcolor{red}{\underline{\textipa{u}}}};
	\node at (1.5,2.5){\textcolor{red}{\underline{\textipa{U}}}};
	\node[left] at (2,2){\textipa{7}};
	\node[right] at (2,2){\textcolor{red}{\underline{\textipa{o}}}};
	\node[left] at (2,1){\textipa{2}};
	\node[right] at (2,1){\textcolor{red}{\underline{\textipa{O}}}};
	\node[right] at (2,0){\textipa{6}};
	\node[left] at (2,0){\textipa{A}};
	\draw[black] (2,0)--(2,3);
	\node[left] at (0.5,2){\textipa{9}};
	\node[right] at (0.5,2){\textipa{8}};
	\node at (0.625,1.5){\textcolor{red}{\underline{\textipa{@}}}};
	\node[left] at (0.75,1){\textipa{3}};
	\node[right] at (0.75,1){\textipa{\textcloserevepsilon}};
	\node at (0.875,0.5){\textcolor{red}{\underline{\textipa{5}}}};
	\node at (1,0){\textcolor{red}{\underline{\textipa{a}}}};
	\node[right] at (-1.5,3){\textcolor{red}{\underline{\textipa{y}}}};
	\node[left] at (-1.5,3){\textcolor{red}{\underline{\textipa{i}}}};
	\node at (-0.5,2.5){\textcolor{red}{\underline{\textipa{I}} \textipa{\underline{Y}}}};
	\node[right] at (-1,2){\textcolor{red}{\underline{\textipa{\o}}}};
	\node[left] at (-1,2){\textcolor{red}{\underline{\textipa{e}}}};
	\node[right] at (-0.5,1){\textcolor{red}{\underline{\textipa{\oe}}}};
	\node[left] at (-0.5,1){\textcolor{red}{\underline{\textipa{E}}}};
	\node[right] at (0,0){\textipa{\OE}};
	\draw[black] (0,0)--(-1.5,3);
	\draw[black] (-0.5,2)--(0.2,2);
	\draw[black] (0.85,2)--(1.6,2);
...
\frametitle{Konsonantenklassifikation: Zusammenfassung und Übung}
	...
	\begin{itemize}
		...
		%% \item[] Busch, malen, Maus, Achtung, Genie, zirpen, wichtig, Wald
                ...
                %%       [ˈmaːlən],
                %%       \pause
                %%           [maʊ̯ʊs] mit Bogen unter u (Wiktionary) [maʊ̯s] umgekehrtes c mit Bogen drunter
                %%           \pause
                %%               [ˈaχtʊŋ]
                %%               \pause
                %%                   [ʒeˈniː]
                %%                   \pause
                %%                       [ˈʦɪʁpn̩] Fehlt das n mit unterstrich im Wörterbuch ein m
                %%                       \pause
                %%                           [ˈvɪçtɪç]
                %%                           \pause
                %%                           [valt]
...
\frametitle{Lösung}
\begin{itemize}
	\item Busch: kurzer, gerundeter, halbhoher, velarer Vokal [\textipa{bUS}]
	\item malen: langer, ungerundeter, tiefer, zentraler Vokal + Schwa-Laut [\textipa{ma:l@n}]
	\item Maus: Diphtong [\textipa{m\t{aU}s}]
	\item Achtung: [\textipa{aXtU\ng}] ungerundeter, kurzer, tiefer, zentraler Vokal + kurzer, gerundeter, halbhoher, velarer Vokal
	\item Genie: 
\end{itemize}
\end{frame}
