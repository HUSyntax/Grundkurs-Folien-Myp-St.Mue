...
\pause 
	...
	\ea \textipa{[\textscr\ a: t]} und \textipa{[\textscr~E:~t~@]}, \textipa{[\textscr\ a: t]} und \textipa{[\textscr\ E: d 5]}, \textipa{[b E t]} und \textipa{[b E t @ n]}, \textipa{[b a: t]} und \textipa{[b~E:~d~5]}, \textipa{[k I n t]} und \textipa{[k I n d 5]}
	\z 
...
\begin{itemize}
	...
	\item[] \gq{Ein Segment \emph{A} im Input wird zu einem Segment \emph{B} im Output in einem Kontext (\gqq{/}), in dem \emph{C} \textit{vor} und \emph{D} \textit{nach} \emph{A} vorkommt.} 
\end{itemize}
