...
\begin{itemize}
	...
	\ea \textipa{[St\textscr]} am Wortanfang aber nicht am Wortende \textipa{[St{\textscr}\t{a\textupsilon}x]} \vs *\textipa{[\ldots aSt\textscr]}
	\z
...
\begin{itemize}
	...
	\item[]
	\item Wenn das Deutsche ein neues Wort wie \ab{Code} \textipa{[k @ \textupsilon\ d]} entlehnen würde, würde dieses Wort früher oder später \gqq{eingedeutscht} werden.
	
	\ea \textipa{[k O \textupsilon\ t]} oder \textipa{[k o: t]} aber \gqq{des \textipa{[k O \textupsilon\ d @ s]}} oder \gqq{des \textipa{[k o: t s]}} 
	\z
...
\begin{itemize}
	...
	\eal
		...
		\ex \ab{kaufe}: \textipa{/k\t{a\textupsilon}.f@/} \ras \textipa{[k\t{a\textupsilon}f]}
		\ex \ab{Kumpel}: \textipa{/k\textupsilon m.p@l/} \ras \textipa{[k\textupsilon m.p\textsyllabic{l}]}
	\zl
	...
	\begin{itemize}
		...
		\ea \ab{Tilgung}: \textipa{[tIl.g\textupsilon Ng]} \ras \textipa{[tIl.g\textupsilon N]}
		\z
...
\begin{itemize}
	...
	\eal
		\ex \abu{Enttäuschung}: \textipa{/Ent.t\t{OI}.S\textupsilon ng/} \ras \textipa{[PEn\.t\t{OI}.S\textupsilon N]}
...
\begin{itemize}
	...
	\eal		
		\ex \abu{Führung}: \textipa{/fy:.{\textscr}\textupsilon ng/} \ras \textipa{[fy:.{\textscr}\textupsilon Ng]} (nach g-Tilgung \ras \textipa{[fy:.{\textscr}\textupsilon N]})
		\ex \ab{Bank}: \textipa{/bank/} \ras \textipa{[baNk]}
		\ex ABER \ab{ungern}: \textipa{/\textupsilon n.gE{\textscr}n/} \ras \textipa{[P\textupsilon n.gE{\textscr}n]} oder fakulativ \textipa{[P\textupsilon N.gE{\textscr}n]}
	\zl
...
\begin{itemize}
	...
	\eal
		...
		\ex \ab{Schuppen}: \textipa{/S\textupsilon p@n/} \ras 
		\textipa{[S\textupsilon \.p\textsyllabic{n}]} \ras \textipa{[S\textupsilon \.p\textsyllabic{m}]}
	\zl
	...
	\eal
		...
		\ex \ab{Buch}: \textipa{/b\textupsilon \c{c}/} $\rightarrow$ \textipa{[b\textupsilon x]}
...
\begin{itemize}
	...
	\eal
		...
		\ex \ab{Endspurt}: \textipa{/End.Sp\textupsilon {\textscr}t/} \ras \textipa{[PEnt.Sp\textupsilon {\textscr}t]}
