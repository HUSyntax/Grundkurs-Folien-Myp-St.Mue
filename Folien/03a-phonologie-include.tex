...
\begin{itemize}
	...
	\eal
		...
		\ex \ab{Kumpel}: \textipa{/kU m.p@l/} \ras \textipa{[kU m.p\textsyllabic{l}]}
	\zl
	...
	\begin{itemize}
		...
		\ea \ab{Tilgung}: \textipa{[tIl.gU Ng]} \ras \textipa{[tIl.gU N]}
		\z
...
\begin{itemize}
	...
	\eal
		\ex \abu{Enttäuschung}: \textipa{/Ent.t\t{OI}.SU ng/} \ras \textipa{[PEn\.t\t{OI}.SU N]}
...
\begin{itemize}
	...
	\eal		
		\ex \abu{Führung}: \textipa{/fy:.{\textscr}U ng/} \ras \textipa{[fy:.{\textscr}U Ng]} (nach g-Tilgung \ras \textipa{[fy:.{\textscr}U N]})
		\ex \ab{Bank}: \textipa{/bank/} \ras \textipa{[baNk]}
		\ex ABER \ab{ungern}: \textipa{/U n.gE{\textscr}n/} \ras \textipa{[PU n.gE{\textscr}n]} oder fakulativ \textipa{[PU N.gE{\textscr}n]}
	\zl
...
\begin{itemize}
	...
	\eal
		...
		\ex \ab{Schuppen}: \textipa{/SU p@n/} \ras 
