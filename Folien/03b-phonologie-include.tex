...
\ea
Tschechisch \textipa{[\alertred{fspl}a.nout]} \gq{aufflammen}
\z

\ea
Hawaianisch \textipa{[a.\alertred{l}o.\alertred{h}a]} \gq{Liebe}
\z

\ea
Deutsch \textipa{[\alertred{St\textscr}aIt]} \gq{Streit}
\z
...
\end{itemize}
	...
	CVC$^{n}$]$_{\sigma}$ $>$ CVC$^{n+1}$]$_{\sigma}$ (wobei $n \geq 1$)
...
\begin{figure}
	...
	\node at (-3,1) {Obstruent};
	\node at (-3,2) {Sonorant};
	\node at (-3,3) {Nasal};
	\node at (-3,4) {\textipa{/l/}};
	\node at (-3,5) {Vokal};
	\draw[black] (0,1) -- (1,4) -- (2,5) -- (3,2) -- (4,1);
	\node at (0,-1) {\textipa{p}};
	\node at (1,-1) {\textipa{l}};
	\node at (2,-1) {\textipa{U}};
	\node at (3,-1) {\textipa{m}};
...
%@EE: Die folgende Übung + Lösung sollten wir besser aufbauen Frage+Antwort
...
% Glottal stop gehört zu den Plosiven
	...
	\ea *\textipa{[lbat]}, *\textipa{[blabl]}, *\textipa{[m{\textscr}apt]}, *\textipa{[ki:l\textscr]}, *\textipa{[ngang]}
	\z
...
\hfill
	\begin{tikzpicture}[scale=0.4]
		...
		\node at (0,-1.13) {\textipa{S}};
		\node at (1,-1.23) {\textipa{p}};
		\node at (2,-1.13) {\textipa{a}};
		\node at (3,-1) {\textipa{\texttoptiebar{ts}}};
...
\pause
	\hfill
		...
		\node at (0,-1) {\textipa{d}};
		\node at (1,-1.13) {\textipa{a}};
		\node at (2,-1) {\textipa{k}};
		\node at (3,-1.13) {\textipa{s}};
...
\hfill
		...
		\node at (0,-1) {\textipa{k}};
		\node at (1,-1) {\textipa{l}};
		\node at (2,-1) {\textipa{\texttoptiebar{aU}}};
		\node at (3,-1.15) {\textipa{n}};
		\fill (0,0.5) circle [radius=3pt];
		\fill (1,4) circle [radius=3pt];
		\fill (2,5) circle [radius=3pt];
...
\frametitle{Lösung}
	...
	\ea[*]{\textipa{[lbat]}\only<2->{: \textipa{[l]} vor \textipa{[b]} im Onset} }
	
	\ex[*]{\textipa{[blabl]}\only<3->{: \textipa{[b]} vor \textipa{[l]} in der Koda $+$ Auslautverhärtung} }
	
	\ex[*]{\textipa{[m{\textscr}apt]}\only<4->{: \textipa{[m]} vor \textipa{[\textscr ]} im Onset} }
	
	\ex[*]{\textipa{[ki:l\textscr]}\only<5->{: \textipa{[l]} vor \textipa{[\textscr ]} in der Koda} }
	
	\ex[*]{\textipa{[ngang]}\only<6->{: \textipa{[n]} vor \textipa{[g]} im Onset $+$ reg. velare Nasalassimiliation $+$ g-Tilgung} }
	
	\ex[*]{\textipa{[krafm]}\only<7->{: \textipa{[f]} vor \textipa{[m]} in der Koda} }
	\ex[*]{\textipa{[elat]}\only<8->{: 2 Silben (2 Nuklei) $+$ Knacklauteinsetzung} }
	\ex[*]{\textipa{[plaml]}\only<9->{: \textipa{[m]} vor \textipa{[l]} in der Koda} }
	\ex[*]{\textipa{[nfatl]}\only<10->{: \textipa{[n]} vor \textipa{[f]} im Onset $+$ \textipa{[t]} vor \textipa{[l]} in der Koda} }
	\z 
...
%@EE: Hausaufgabe + Lösung hinzufügen
