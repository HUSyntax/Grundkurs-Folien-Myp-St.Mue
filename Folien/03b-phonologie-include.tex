...
\begin{minipage}{0.39\textwidth}
	...
	\scalebox{.65}{
		...
		[UP
		[IP
		[$\Phi$[$\omega$[F[$\sigma$][$\sigma$]][F[$\sigma$][$\sigma$]]]]
		[$\Phi$[$\omega$[F[$\sigma$][$\sigma$]]][$\omega$[F[$\sigma$][$\sigma$]]]]
		]]
		\end{forest}
	}
		\caption{Hierarchie in der Äußerungsphrase}
	\end{figure}
\end{minipage}\hfill%
...
\ea
Tschechisch \textipa{[fspla.nout]} `aufflammen'
\z
...
\ea
Deutsch \textipa{[St\textscr aIt]} `Streit'
\z
...
\pause
		\item \dots\ welche \textbf{phonotaktischen Beschränkungen} für die Koda in deutschen Silben gelten könnten:
                  ...
                  \ea
                  *\textipa{[katl]}, *\textipa{[hat\textscr ]}, *\textipa{[latn]},
                  *\textipa{[k\textscr akN]}
                  \z
...
\begin{itemize}
	...
	\ea *\textipa{[katl]}, *\textipa{[hat\textscr ]}, *\textipa{[latn]}, *\textipa{[k\textscr
            akN]}
        \z
...
\begin{itemize}
	...
	\begin{itemize}
		\item Dann ist der Onset leer.
		  \ea
                  \textipa{[\textprimstress PaI.5]}
                  \z

		  \ea
                  \textipa{[PEt.\textprimstress va:.I\c{c}]}
                  \z
...
%	]]
%	[$\sigma$
%		[O{\draw[black] (.south)--++(-2.38em,-1.7ex);}]
%		]
%	[R
%		[N
%			[x[\textipa{@}]]
...
%]
%[$ \sigma $
%	[O]{\draw[black] (.south)--++(-1.6em,-6.2ex);}
%[R
%	[N
%		[x[\textipa{a}]]
%	]
...
\begin{itemize}
	...
	\z
	\ea
        abkli\alert{ng}en, zwi\alert{sch}en
        \z
