...
\begin{minipage}{.3\textwidth}
	\begin{figure}
		\centering
		\scalebox{.7}{\begin{tikzpicture}[scale=0.5]
...
\begin{frame}
	\begin{itemize}
		...
		\iftoggle{loesung}{
			...
			\begin{itemize}
		\item \textcolor{red}{zu (59a): Onset-Maximierung \textipa{[pl]}, \textipa{[N]} steht am Wortanfang, \textipa{[O]} ist ungespannt und lang}
		\item \textcolor{red}{zu (59b): Auslautverhärtung, regressive velarare nasale Assimilation, Knacklaut}
		\end{itemize}
