...
\begin{itemize}
	...
	\ex Fabrik\loesung{2}{\textipa{[fa:.b\textscr Ik]}}
	\ex Imker\loesung{3}{\textipa{[PIm.k5]}}
	\ex neblig\loesung{4}{\textipa{[ne:.blI\c{c}]}}
	\ex Falter\loesung{5}{\textipa{[fal.t5]}}
	\ex regnen\loesung{6}{\textipa{[\textscr e:.gn@n]}}
		
	\loesung{7}{Koda: *Obstruent vor Sonorant}
	\loesung{8}{Onset: *Sonorant vor Obstruent}
...
\frametitle{Übung}
	...
	\settowidth\jamwidth{XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}
		...
		\ex \textipa{[PEb.@]}\loesung{3}{\ras Auslautverhärtung}
		\ex \textipa{[PEp.@]}\loesung{4}{\ras Onset-Maximierung}
		\ex \textipa{[PEp.b@]}\loesung{5}{\ras keine Regelverletzung}
	\zl
...
=======
\item \ref{ex:HA2}a und \ref{ex:HA2}b sind einfach nach der Lautfolge silbifiziert;\\
>>>>>>> 7d01ed4b8bd81ecd2c3777e57fc7a7329b2cd10e
