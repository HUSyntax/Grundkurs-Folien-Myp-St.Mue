...
\exr{ex:HA3}
\begin{xlist}
\ex[*]{\textipa{['Napl.O:t]}: \pause
	\textcolor{red}{Onset-Maximierung \textipa{[pl]}, \textipa{[N]} steht am Wortanfang, \textipa{[O]} ist ungespannt und lang}}
\ex[*]{\textipa{[a\;R.'tUng]}: \pause
	\textcolor{red}{Auslautverhärtung, regressive velarare nasale Assimilation, Knacklaut}}
\end{xlist}
