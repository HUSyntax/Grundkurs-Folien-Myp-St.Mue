...
\begin{itemize}
	...
	\ex Fabrik\jambox{\only<2->{\textcolor{red}{
			\textipa{[fa:.b\textscr Ik]}
		}}}
	\ex Imker\jambox{\only<3->{\textcolor{red}{
			\textipa{[PIm.k5]}
		}}}
	\ex neblig\jambox{\only<4->{\textcolor{red}{
			\textipa{[ne:.blI\c{c}]}
		}}}
	\ex Falter\jambox{\only<5->{\textcolor{red}{
			\textipa{[fal.t5]}
		}}}
	\ex regnen\jambox{\only<6->{\textcolor{red}{
				\textipa{[\textscr e:.gn@n]}
			}}}
		
	\jambox{\only<7->{ \textcolor{red}{Koda: *Obstruent vor Sonorant} } }
	\jambox{\only<8->{ \textcolor{red}{Onset: *Sonorant vor Obstruent} } }
...
\frametitle{Übung}
	...
	\settowidth\jamwidth{XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX}
		...
		\ex \textipa{[PE.b@]}\jambox{\only<2->{\textcolor{red}{
			\ras Kurzvokal} Lösung \zb Silbengelenk \textipa{[PE\.b@]}
		}}
		\ex \textipa{[PEb.@]}\jambox{\only<3->{\textcolor{red}{
			\ras Auslautverhärtung
	}}}
		\ex \textipa{[PEp.@]}\jambox{\only<4->{\textcolor{red}{
			\ras Onset-Maximierung
	}}}
		\ex \textipa{[PEp.b@]}\jambox{\only<5->{\textcolor{red}{
			\ras keine Regelverletzung
	}}}
	\zl
