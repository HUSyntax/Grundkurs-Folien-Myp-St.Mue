...
\begin{itemize}
	...
	\ea \ab{war\alertred{d}} vs. \ab{war\alertred{t}} \only<3->{ \ras \ab{d} \vs \ab{t}}
	
	\ex \ab{w\alertred{a}rt} vs. \ab{w\alertred{o}rt} \only<3->{ \ras \ab{a} \vs \ab{o} }
	
	\ex \ab{\alertred{w}art} vs. \ab{\alertred{p}art} \only<3->{ \ras \ab{w} \vs \ab{p} }
	
	\ex \ab{pa\alertred{r}t} vs. \ab{pa\alertred{ch}t} \only<3->{ \ras \ab{r} \vs \ab{ch} }
	\z
\end{itemize}
