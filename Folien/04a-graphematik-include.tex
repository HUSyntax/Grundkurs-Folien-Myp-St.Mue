...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\iftoggle{ue-loesung}{
	\input{loesungen/04a-ue-loesung01-include}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\iftoggle{ue-loesung}{
%	\input{loesungen/04a-ue-loesung02-include}
}
...
\begin{itemize}
	...
	\begin{itemize} 
		...
		\item Markierung der \textbf{Gespanntheit} durch ein \ab{\textbf{h}} \textbf{nach dem Vokal} (Dehnungs-h) 
		
		\ea \ab{M\alertred{eh}l}, \ab{ho\alertred{h}l}, \ab{Ba\alertred{h}n}
		\z
	\end{itemize}
\end{itemize}
