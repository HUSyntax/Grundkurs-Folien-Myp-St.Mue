...
\begin{itemize}
	\item Grundformen (\zB Grapheme) sind primär auf \textbf{bedeutungsunterscheidende} Elemente (\zB Phoneme) im Sprachsystem bezogen.
...
Korrespondenz zwischen \textbf{graphischem Zeichen} (Buchstaben) und \textbf{Lauten}  (Deutsch, Russisch, Arabisch, \dots)
	...
	\begin{itemize}
		...
		enthält Grapheme für Konsonanten und Vokale (\zB Deutsch)
		
		\item \textbf{Konsonantenschrift:}\\
		enthält Grapheme (fast) nur für Konsonanten (\zB nordwestsemitische Schriftarten, Arabisch, \ldots) 
	\end{itemize}
...
\begin{itemize}
	\item Grundformen sind primär auf \textbf{bedeutungstragende} Elemente (\zB Wörter oder Morpheme) im Sprachsystem bezogen. 
...
Phonemen mithilfe von Graphemen
		\item Abbildung von Phonemen auf Grapheme = \textbf{Phonem-Graphem-Korrespondenz} (PGK)
