...
\begin{frame}
	...
	\begin{itemize}
		\item[4.] Erläutern Sie stichpunktartig, welche (graphematische) Funktionen der Buchstabe \ab{h} in den folgenden Kontexten annimmt:
		\eal
		\ex Ha\underline{h}n: \pause Dehnungs-\ab{h}
\pause
		\ex nä\underline{h}en: \pause Silbentrennendes \ab{h}
\pause
		\ex bein\underline{h}alten: \pause Wiedergabe eines Phonems \textipa{[h]} nach den Phonem-Graphem-Korrespondenzen
\pause
		\ex Gesc\underline{h}ichte: \pause Teil eines Trigraphen \ab{sch}\\(Achtung! Nicht Teil eines Lauts sondern eines Graphems!)
\pause
		\ex Geschic\underline{h}te: \pause Teil eines Digraphen \ab{ch}\\(Achtung! Nicht Teil eines Lauts sondern eines Graphems!)
\pause
		\ex Dip\underline{h}thong: \pause Teil eines Fremddigraphen \ab{ph}
\pause
		\ex Dipht\underline{h}ong: \pause Teil eines Fremddigraphen \ab{th}
		\zl
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item[] Phonologisch: \pause\textipa{/ a b S t E l k a m @ \textscr~/}
\pause
		\item[] Phonetisch: \pause\textipa{[ P a p S t E l k a m 5 ]}
\pause
		\item[] Phonographisch: \pause\ab{ a b sch t e l k a m e r } 
