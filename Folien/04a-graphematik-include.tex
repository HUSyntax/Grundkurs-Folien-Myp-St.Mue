...
\begin{itemize}
	...
	\ea \ab{fertig} nicht mit \ab{v}, sondern mit \ab{f} \ras \ab{fer} in \ab{fertig} hat nicht die gleiche Bedeutung wie \ab{ver} in \ab{verpetzt} oder \ab{verschreiben}
	\z
...
\begin{itemize}
	...
	\ea Deutsch: \ab{k} für Laut \textipa{[k]}
	\z 
\end{itemize}
...
\begin{itemize}
	\item \textbf{Großschreibung für Substantive} und Substantivierungen von Adjektiven, Verben, Adverbien und Partikeln (natürlich auch von \textbf{Satzanfängen} und \textbf{Anrede} (\ab{\alertred{S}ie}/\ab{\alertred{I}hr})
