...
\begin{itemize}
	...
	\ea
		\ea\label{ex:Konf1} \alertred{Bio}-\alertred{log}e
		\ex \alertred{Soft}-ie
...
\begin{enumerate}
	...
	\begin{exe}
		\item verteilenden %ver- teil -end -en
		\item Bereinigungsanlage %be- rein -ig -ung(-s) an- lag -e
		\item Hausarbeit %haus arbeit
	\end{exe}	
