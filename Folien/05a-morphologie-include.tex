...
\pause 
	...
	\begin{itemize}
		...
		\ea kindlich \textipa{[kInt.\alertred{lI\c{c}}]} \vs kindisch \textipa{[kIn.dIS]}:\\
...
\pause 
		...
		\ea ungern \textipa{[\alertred{PUn}.gE\;Rn]} \vs Leistung \textipa{[l\t{aI}s.tUN]}:\\
		\ab{un-} ist ein phonolog. Wort, \ab{-ung} nicht.
		\z 
