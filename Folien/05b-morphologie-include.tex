...
\pause 
	\ex
	\ea\label{ex:Bsp6}  ((Frau(-en)$+$film)$+$fest) $=$ \alertblue{Fest}, das etwas mit \alertred{Frauenfilmen} (\zB Filmen von weiblichen Regisseurinnen) zu tun hat
	
	\ex\label{ex:Bsp7}  (Frau(-en)$+$(film$+$fest)) $=$ \alertblue{Filmfest}, das etwas mit \alertred{Frauen} zu tun hat (\zB Filmfest wird von Frauen organisiert)
	\z 
	\z 
\end{itemize}
