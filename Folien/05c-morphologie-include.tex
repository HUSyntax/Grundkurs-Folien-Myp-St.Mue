...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Bedeutung von Affixen}
%\frame{
%%\begin{multicols}{2}
%\frametitle{~}
%	\tableofcontents[currentsection, hideallsubsections]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Produktive und aktive Muster}
%\frame{
%%\begin{multicols}{2}
%\frametitle{~}
%	\tableofcontents[currentsection, hideallsubsections]
...
%@EE: Eins16g muss in die Bib für den GK kopiert werden
\end{itemize}
...
\alertred{\MyPdown{V}}ausgezeichnet \ras  \alertred{\MyPdown{A}}ausgezeichnet(e)
\z
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Untertypen der Konversion}
%\frame{
%	\frametitle{~}
%	%	\begin{multicols}{2}
%	\tableofcontents[currentsection, hideallsubsections]
...
\eal 
\ex \alertred{\MyPdown{V}}lauf(\alertred{-en}) \ras  (das) \alertred{\MyPdown{V}}Lauf\alertred{en} 
\ex \alertred{\MyPdown{A}}arbeitslos(\alertred{-e})/(\alertred{-er}) \ras (der) \alertred{\MyPdown{N}}Arbeitslos\alertred{e}, (ein) \alertred{\MyPdown{N}}Arbeitslos\alertred{er}
...
\ea \alertred{\MyPdown{V}}find(-en) \ras \alertred{\MyPdown{N}}F\alertred{u}nd
\ex \alertred{\MyPdown{V}}greif(-en) \ras \alertred{\MyPdown{N}}Gr\alertred{i}ff
\z 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Exkurs: Andere Wortbildungsarten}
\frame{
\frametitle{~}
%	\begin{multicols}{2}
\tableofcontents[currentsection, hideallsubsections]
...
\ea Tempo (für \gq{Taschentücher}), Fit (für \gq{Spülmittel})%, OB
\z
...
\begin{itemize}
\item[5.] Warum sind die Wörter unter \ref{05cHA5a} grammatisch und die unter \ref{05cHA5b} ungrammatisch? %(4 Punkte)
\eal\label{ex:05cHA5}
