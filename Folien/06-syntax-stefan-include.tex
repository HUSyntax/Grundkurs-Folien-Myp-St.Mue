...
\includegraphics[width=\textwidth]{lach-dich-schlapp-pappa-versteckte}
...
\vfill
\includegraphics[width=\textwidth]{lach-dich-schlapp-die-maus-bemalte}
...
\exewidth{(370)}
% \input{4a-gengram-tmodell}
% \input{4b-gengram-cpip}
