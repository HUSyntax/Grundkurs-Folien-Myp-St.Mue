...
Entscheidend:
\begin{itemize}
	\item Manche Elemente gehören enger zusammen als andere (\textbf{phrasale Konstituente}): 

	\ea {[Der Vater von Klaus] [kommt] [morgen].}
	\z
	
	\item Rolle der \textbf{Kategorie} von Konstituenten:\\
	Das \textbf{finite} (gebeugte) \textbf{Verb} im Satz muss nach vorne bewegt werden.
...
%\ea 
	...
	\ex Sitzt dem Hund unter Stuhl kleine der.
	%Ungrammatisch
	...
	\ex Weil die Studenten lieben Syntax, bin ich glücklich.
	%Weil mit Hauptsatz
	\z 
...
\begin{figure}
	\centering
	\includegraphics[scale=.05]{material/DudenRichtigesDeutsch}
