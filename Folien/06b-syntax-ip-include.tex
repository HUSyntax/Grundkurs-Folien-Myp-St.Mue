...
\item Biologen sagen uns, dass es unrealistisch ist, anzunehmen, dass reichhaltiges linguistisches
  Wissen in unserem Genom kodiert ist.
...
\item Spracherwerb wäre einfacher, wenn Lerner (Kinder) schön wüssten, dass alle sprachlichen
  Ausdrücke eine bestimmte Struktur haben.
...
Im Englischen kann des Nomen weniger gut weggelassen werden als im Deutschen, was für das Nomen asl
Kopf spricht.

\item Kopf bestimmt die Form der anderen Elemente

In der Nominalgruppe liegt Kongruenz vor, weshalb dieses Kriterium nicht weiterhilft.

Genus ist eine inhärente Eigenschaft des Nomens, was eher für das Nomen als Kopf spricht.
...
\begin{itemize}
\item 0--1980: N ist der Kopf
\item 1985-heute: D ist der Kopf
...
Um (\mex{-1}) zu lernen, reichen \zb die Sätze in (\mex{1}) aus:
\eal
...
\frame{
\frametitle{Analysis with Subtrees and Probabilities}
