...
\pause 
	\alertgreen{Deklarativsatz (V2), unmarkierte Mitteilung}
...
\pause	
	\alertgreen{E-Interrogativsatz (V1), auffordernde Frage (\ras Beeil dich!), Antwort wird verlangt}
...
\pause
	\alertgreen{Imperativsatz, Aufforderung}

\ex \label{ex:Geld} Wenn ich nur Geld hätte!

\pause
	\alertgreen{Optativ (VL + wenn), irrealer Wunsch}
...
\pause 
	\alertgreen{K-Interrogativ (V2), Antwort auf Fragewort wird verlangt}


\ex \label{ex:gewonnen} Ich habe gewonnen!

\pause
	\alertgreen{Exklamativ}
