...
\node[below] at (0,0) [rectangle,draw]{Lexikon};
\draw[->] (0,-0.5)--(0,-0.9);
...
\draw[<->] (-2,-4)--(-2,-4.5);
\draw[<->] (2,-4)--(2,-4.5);
\node[below,text width=3.4 cm, align=center] (A) at (-2,-4.5) [rectangle, draw] {Artikulatorisch-perzeptorischer Apparat};
\node[below,text width=3.5 cm, align=center] (B) at (2,-4.5) [rectangle, draw] {Konzeptuell-intentionales System};
\node[text width=5 cm, align=center] (C) at (7,-2.5) [rectangle, draw] {Grammatik Phonologische Komponente Morphologische Komponente Syntaktische Komponente Semantische Komponente};
\end{tikzpicture}
