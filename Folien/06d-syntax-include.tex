...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \alertred{Rektions-Bindungs-Theorie} (GB; \citealt{Chomsky81a})
...
\end{itemize}
\pause
\eal Peter kauft \alertred{[das erfrischende Wasser, das ich dir letztens empfohlen habe]}.
\pause
\ex \textbf{Vorfeldtest}\\
\alertred{{[}Das erfrischende Wasser, das ich dir letztens empfohlen habe]} kauft Peter. 
\pause
\ex \textbf{Fragetest}\\
\alertred{{[}Was]} kauft Peter? \ras \alertred{{[}Das erfrischende Wasser, das ich dir letztens empfohlen habe]}
\zl
...
\pause
	\item Welches Element in der Phrase\\
	Peter wartet \alertred{[an der Ecke]}.\\
	steuert die Interpretation?
\pause
	\item[\ra] \emph{an} (Lokation)
\pause
	\item Welches Element in der Phrase\\
	Peter \alertred{[wartet an der Ecke]}.\\
	steuert die Interpretation?
 \pause
...
\begin{itemize}
	...
	\item Geben Sie den Subkategorisierungsrahmen (in dem besprochenen Format) und einen Beispielsatz für die folgenden Wörter an:
...
%	wissen, donnern, scheinen, mit, erschrecken, ängstigen, fürchten, Banane, Tatsache, warten, Angst, wohnen, bewohnen, auf, malen, krank, bemalen, fragen
