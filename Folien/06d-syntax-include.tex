...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Phrasenaufbau \ras Argumentstruktur}
...
\begin{itemize}
	...
	\item Bestimmen Sie in den folgenden Sätzen, welche Phrasen Argumente sind und welche Phrasen Modifikatoren des Verbs sind, und begründen Sie Ihre Entscheidung.
...
\input{loesungen/06d-ha-loesung-include}
}
