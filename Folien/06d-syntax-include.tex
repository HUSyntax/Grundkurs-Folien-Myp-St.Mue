...
%{\textcolor{green}{	
\begin{itemize}
	\item Kopf: Schüler (vorläufig)
	\item Interpretation: Es geht um \emph{Schüler}
	\item Distribution: Innerhalb einer PP wird eine (DP/)NP selegiert. Der Kopf dieser NP ist das Nomen.
	\item Phrasenaufbau: Alle anderen Modifikatoren beziehen sich auf das Nomen. 
\end{itemize}
%}	
...
%{\textcolor{green}{	
%		\begin{itemize}
%			\item Kopf: Redner (vorläufig)
%			\item Interpretation: Es geht um \emph{Redner}
%			\item Distribution: Innerhalb einer PP wird eine (DP/)NP selegiert. Der Kopf dieser NP ist das Nomen.
%			\item Phrasenaufbau: Alle anderen Modifikatoren beziehen sich auf das Nomen. 
%		\end{itemize}
%}	
...
\begin{itemize}
	...
	\item Geben Sie für die folgenden Wörter den Subkategorisierungsrahmen (in dem besprochenen Format) und einen Beispielsatz, der den von Ihnen angegebenen Subkategorisierungsrahmen illustriert, an:
