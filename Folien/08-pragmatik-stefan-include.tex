...
% \hline
\visible<5->{Bewertung nach formalen Kriterien:\newline grammatisch oder ungrammatisch} & \visible<5->{Bewertung nach pragmatischen Kriterien: adäquat oder inadäquat}\\
% \hline
...
\begin{frame}{Kernbereiche: Deixis}
...
\begin{itemize}[<+->]
\item Austin (und \citew{Searle1969}): Nicht alle Äußerungen beschreiben die Welt. Für viele Äußerungen ist wahr/falsch kein adäquates Kriterium.
