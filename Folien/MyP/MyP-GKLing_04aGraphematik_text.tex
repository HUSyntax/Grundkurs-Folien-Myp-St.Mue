\newtoggle{uebung}\togglefalse{uebung}
...
\begin{itemize}
	...
	\item[]
		...
		\ex.\label{ex:Bsp1} Du bist schlau.

		\ex. \label{ex:Bsp2} Nein.
\pause		
	\item[]
	...
	\item[]
		...
		\ex. DU bist aber \gqq{schlau}!
		
		\ex. nein $|$ NEIN $|$ nein! $|$ nein. $|$ NEIN. $|$ *nein
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Graph, Graphem, Allograph}
\frame{
\begin{multicols}{2}
\frametitle{~}
	\tableofcontents[currentsection]
...
\pause
		...
		\ex. \ab{war\emph{d}} vs. \ab{war\emph{t}} \ras \ab{d} vs. \ab{t}

		
		\ex. \ab{w\emph{a}rt} vs. \ab{w\emph{o}rt} \ras \ab{a} vs. \ab{o}

		
		\ex. \ab{\emph{w}art} vs. \ab{\emph{p}art} \ras \ab{w} vs. \ab{p}


		\ex. \ab{pa\emph{r}t} vs. \ab{pa\emph{ch}t} \ras \ab{r} vs. \ab{ch}
...
\frametitle{Graph, Graphem, Allograph}
	...
	\begin{itemize}
		...
		\item Ein Graph, ein Allograph und ein Graphem notiert man mit den spitzen klammern \ab{}
			...
			\ex. Allographe von \ab{a}: \ab{\textit{a}} \ab{\textswab{a}} \ab{a} \ab{\textfrak{a}} %(hier verschiedene Schriftarten, RF)
...
%	\item[]
	...
	\ex. Bsp. Wie wird das Wort \textipa{[\textscr a:t]} geschrieben?
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. Graphik/Grafik, Cousine/Kusine, Friseur/Frisör, Nougat/Nugat, so dass/sodass, mithilfe/mit Hilfe, \dots
			
		\item Abweichungen in der Schreibung können auch auf internen, nicht-kodifizierten Normen beruhen
			
		\ex. die Klassiker Bibliothek, Ulla's Lädchen, Hits für Kid's, BahnCard, StudentInnen, \dots
...
\begin{itemize}
	...
	\ex. \ab{fertig} nicht mit \ab{v}, sondern mit \ab{f} \ras \ab{fer} in \ab{fertig} hat nicht die gleiche Bedeutung wie \ab{ver} in \ab{verpetzt} oder \ab{verschreiben}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. Deutsch: \ab{k} für Laut \textipa{[k]}
...
\ex. Grobe Übersicht der Schrifttypen:
\begin{figure}
\centering
\begin{forest}
sn edges,
	[\textbf{Schrifttypen}
		[\textbf{logographischer} \\ Schrifttyp [[Chinesisch \\ Hierogylphen]]]
		[\textbf{phonographischer} \\ Schrifttyp
			[\textbf{alphabetischer} \\ Schrifttyp [Latein \\ Griechisch \\ Russisch]]
			[\textbf{syllabischer} \\ Schrifttyp [Japanisch \\ Koreanisch]]]]
\end{forest}
\end{figure}
...
%	\item 
	...
	\ex. Türkisch: \ab{dükkan} für \textipa{[dYkkan]}
	
	\ex. Spanisch: \ab{negocio} für \textipa{[negoTio]}
	
	\ex. Englisch: \ab{business} für \textipa{[bIzn@z]}
	
	\ex. Französisch: \ab{boutique} für \textipa{[butik]}
	
\pause	
	
	\ex. English: \ab{gh o ti} für \ab{fish} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Graphematische Prinzipien}
\frame{
\begin{multicols}{2}
\frametitle{~}
	\tableofcontents[currentsection]
...
Phonem
	...
	\begin{itemize}
		...
		\ex. Wann wird ein \ab{ch} wie in \ab{ich} oder wie in \ab{Buch} ausgesprochen?
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\ex. \abe{Strumpf}, \abe{Bild}
			
			\item wenige Ausnahmen: 
			
			\ex.\abe{Mond}, \abe{Keks}, \abe{Obst}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. \abe{Beet} - \abe{Bett}, \abe{Bahn} - \abe{Bann}
		
		\item Zusätzliche Markierungen möglich, aber nicht immer erforderlich: 
		
		\ex. \abe{an}, \abe{bis}, \abe{rot}, \abe{Hut}
	...
	\end{itemize}
		...
		\ex. \abe{Beet}, \abe{Saal}, \abe{Boot}, \abe{Tier}, \abe{Mehl}
		...
		\ex. \abe{Ebbe}, \abe{Affe}, \abe{Kladde}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. \ab{\textbf{See}}, \ab{\textbf{Armee}}, \ab{\textbf{Klischee}}, \ab{\textbf{Allee}}, \ab{\textbf{Orchidee}}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. \a. \ab{ge-hen}, \ab{Ru-he}, \ab{Mü-he}
			 \b. (oft in Verben) \ab{sehen}, \ab{stehen}
			 \b. (seltener nach Diphthongen) \ab{hauen}, \ab{schauen}
			 \b. (aber nach \ab{ei} beides) \ab{leihen}, \ab{verzeihen}, \ab{schreien}
		
	\end{itemize}
	\item[]
	\item Dehnungs-h vor Sonoranten

	\ex. \ab{Mehl}, \ab{Bohrer}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\ex. \a. \ab{Apfel} - \ab{Äpfel}, nicht \ab{Epfel}
			 \b. \ab{Mutter} - \ab{Mütter}, nicht \ab{Mytter}
			 \b. \ab{Ball} - \ab{Bälle}, nicht \ab{Bal} und \ab{Belle}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Homonymiedifferenzierungsprinzip}
%\frame{
%\frametitle{~}
%	\tableofcontents[currentsection]
%}
...
\begin{itemize}
	...
	\ex. Leib – Laib; Seite – Saite; Lied – (Augen)Lid

	\item Aber:
	
	\ex. Kiefer – Kiefer; Bremse – Bremse; Ton – Ton
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Etymologische Schreibung}
%\frame{
%\frametitle{~}
%	\tableofcontents[currentsection]
%}
...
\begin{itemize}
	...
	\ex. \a. \ab{wann} statt \ab{wan} (wegen mhd. \ab{wanne})
		 \b. \ab{Creme} statt \ab{Krem}
...
\begin{itemize}
	\item Schreibsilben sollten nicht zu lang und nicht zu kurz sein
	 ...
	 \ex. \a. \ab{Spiel} statt \ab{Schpiel}
	 	  \b. \ab{Schwan} statt \ab{Schwahn}
	...
	\ex. \ab{ii} wie \ab{ü}; \ab{uu} wie \ab{w}
	
	\item Verbot von Doppelschreibung von Mehrgraphemen wie
	
	\ex. \a. \ab{ng} in \ab{Bearbeitungngen}
		 \b. \ab{ch} in \ab{Büchcher} 
		 \b. \ab{sch} in \ab{graphischsch}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Syntaktische Schreibung}
%\frame{
%\frametitle{~}
%	\tableofcontents[currentsection]
%}
...
\begin{itemize}
	...
	\item[]
	\item Während der Rechtschreibreform hat man diskutiert, diese abzuschaffen. Was denken Sie: Was spräche dafür, was dagegen?
\end{itemize}
...
\begin{itemize}
	...
	\ex. \ab{Zimmer}, \ab{Waise}, \ab{Wehen}, \ab{Ruhm}, \ab{Spaß}, \ab{Allee}, \ab{Gras}

	\item Welche graphematische Funktion erfüllt das \ab{h} in den folgenden Wörtern?
	
	\ex. \ab{Nacht}, \ab{Hilfe}, \ab{sehen}, \ab{Mehl}
