...
\begin{itemize}
	...
	\item[]
	\item<2-> ABER!: nicht \textit{nur} die menschliche Sprache, sondern auch \textbf{andere Arten von Kommunikationsmitteln} wie Tiersprachen, Körpersprache, künstliche Sprachen, etc\dots (s. Definition \ref{DefSprache4}) und ebenso \textbf{übertragene Bedeutungen} wie Sprache als \gqq{Stil} (s. Definition 	\ref{DefSprache3}), Sprache als \gqq{\textbf{Handlung}} (s. Definition \ref{DefSprache2}) oder Sprache als \gqq{\textbf{Fähigkeit}} (s. Definition \ref{DefSprache1}).
	\item[]
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item[]
			\item<2->[$\rightarrow$] \gqq{Ich habe heute \dots ääähhhh GESTERN die Hausaufgaben abgegeben.}
			\item[]
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item[]
			\item<3->[$\rightarrow$] \gqq{Meine Freundin hat gestern einen Wasserkocher mit Treueherzen von Kaiser's gekauft.}
			\item[]
			\item<3->[$\rightarrow$]  \gqq{Meine Freundin von Kaiser's hat gestern Treueherzen mit einem Wasserkocher gekauft.}
			\item[]
