...
\begin{minipage}[b]{0.45\textwidth}
	...
	\scalebox{0.6}{
		\begin{forest}
			MyP edges,
			[\alertgreen{CP} 
			[\alertgreen{DP$_{k}$} [\alertgreen{Peter},roof]
			]
			  ...
			  [\alertgreen{CP$_i$}
			    [\alertgreen{C$'$}
				  ...
				  [\alertgreen{TP}
					...
					[\alertgreen{T$'$}
					  [\alertgreen{VP} [\alertgreen{V$'$} [\alertgreen{V} [\alertgreen{\trace$_j$}]]]]
					  [\alertgreen{T} [\alertgreen{komm-$_j$ -t}]]]]]]
			  [\alertgreen{C$'$}
			    [\alertgreen{C} [\alertgreen{ha-$_k$ -t$_l$}]]
				  [\alertgreen{TP}
					[\alertgreen{DP}
					  [\alertgreen{D$'$} 
					...
					[\alertgreen{T$'$}
					  [\alertgreen{VP}
						[\alertgreen{CP} [\alertgreen{\trace$_i$}]]
						[\alertgreen{VP}
						  [\alertgreen{V$'$}
						    [\alertgreen{VP} 
							  [\alertgreen{V$'$} 
							...
							[\alertgreen{V} [\alertgreen{\trace$_k$}]]]]]
					  [\alertgreen{T} [\alertgreen{\trace$_l$}]]]]]]
	\end{forest}}
