...
\end{itemize}	
	...
	\begin{itemize}
		...
		\only<2->{\alertgreen{\item Deiktische Elemente:}}
			...
			\begin{itemize}
				 \item \only<3->{\alertgreen{Sie: Sozialdeixis}}
				 \item \only<3->{\alertgreen{diese: Objektdeixis}}
				 \item \only<3->{\alertgreen{gestern: Temporaldeixis}}
				 \item \only<3->{\alertgreen{mir: Personaldeixis}}
				 \item \only<3->{\alertgreen{dort: Lokaldeixis}} 
			\end{itemize}		
	...
	\begin{itemize}
		...
		\only<2->{\alertblue{\item Anaphorische Elemente:}}
			...
			\begin{itemize}
				\item \only<3->{\alertblue{er: anaphorischer Ausdruck; Antezedens: \textit{Peter}}}
				\item \only<3->{\alertblue{sich: anaphorischer Ausdruck; Antezedens: \textit{er}}}
			\end{itemize}
