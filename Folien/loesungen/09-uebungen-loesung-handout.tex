...
\frametitle{Inhaltsverzeichnis}
		...
		\begin{multicols}{6}
			...
			\columnbreak
			\textcolor{white}{
				\ea\label{ex:Skelett1}
				\ex\label{ex:Skelett2}
				\ex\label{ex:Skelett3}
				\ex\label{ex:Segment}
				\ex\label{ex:Segment2}
				\ex\label{ex:Konstituente1}
				\ex\label{ex:Konstituente2}
				\ex \label{ex:XBar1}
				\ex \label{ex:XBar2}
				\ex \label{ex:XBar3}
				\ex \label{ex:XBar4}
				\ex \label{ex:Implikation1}
				\ex \label{ex:Implikation2}
				\ex \label{ex:Präsupposition1}
				\ex \label{ex:Präsupposition2}
				\ex \label{ex:Präsupposition3}
				\ex \label{ex:Präsupposition4}
				\ex \label{ex:Maxime1}
				\ex \label{ex:Maxime2}
				\z
			}
